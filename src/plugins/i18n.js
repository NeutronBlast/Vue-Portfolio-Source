...
export const i18n = new VueI18n({
    ...
    messages:{
        en:{
            ...
            job_one_info: "Built websites for the venezuelan company Per Capital you can access the main page by clicking",
            job_one_link: 'here',
            ...
            education_one: 'Graduted from Informatics Engineering in Universidad Católica Andrés Bello',
            ...
            /* NetDoc */
            netdoc_desc: 'Demo of social media for doctors and patients of rare illnesses',
            netdoc_l1: 'Show interaction between doctors',
            netdoc_l2: 'Show interaction between patients',
            netdoc_l3: 'Show interaction between doctors and patients',
            netdoc_date: 'August 10th, 2020',
            netdoc_v: 'Views',
            netdoc_c1: 'View',
            netdoc_c2: 'Name',
            netdoc_c1r1: 'Posts',
            netdoc_c2r1: 'Write a post in a community you have joined in',
            netdoc_c1r2: 'Communities',
            netdoc_c2r2: 'Explore, post and invite people to a community',
            netdoc_c1r3: 'Discover communities',
            netdoc_c2r3: 'Explore and join different communities',
            netdoc_c1r4: 'Chat',
            netdoc_c2r4: 'Send direct messages to other users and group chats',
            netdoc_c1r5: 'Login/Register',
            netdoc_c1r6: 'Password Recovery',
            netdoc_c1r7: 'Profile/Edit Profile',
            netdoc_c1r8: 'Investigations',
            netdoc_c2r8: 'Discover and take part of investigations from other doctors',
            netdoc_c1r9: 'Patients',
            netdoc_c2r9: 'Manage patients and their medical history',
            netdoc_c1r10: 'Disease searcher',
            netdoc_c2r10: 'Discover everything related to rare illnesses, filter by name or symptoms',
            netdoc_docs1: 'Vision document',
            netdoc_docs2: 'Use cases diagram',
            netdoc_docs3: "Complete system's requeriments",
            netdoc_dd: "Design's document",

            /* Covid 19 */
            covid_tit: 'Covid 19 report system',
            covid_desc: 'Database design to support reports about the people infected with COVID-19',
            covid_l1: 'Create reports using Jaspersoft Studio with the most relevant information about COVID-19 infections worldwide',
            covid_l2: "Build a datamart that uses ETL (Extraction, Transformation, Loading) processes in order to get information from peer's databases",
            covid_l3: "Create and configure user's roles and privileges in the database",
            covid_l4: "Create and execute procedures that simulate in real time the infection process, internet usage, border closing, etc",
            covid_date: 'August 4th, 2020',
            covid_r: 'Reports',
            covid_c1: 'Report',
            covid_c2: 'Description',
            covid_c3: 'Shows',
            covid_c2r2: 'People infected by country, this will allow to count and to detect the infected population and improve the action plans for their recovery',
            covid_c3r2: "Picture, First Name, Middle Name, Surname, Mother's surname (latin america only), Birthdate, Country of residence, State, Other Diseases",
            covid_c2r3: "Person's symptoms of COVID-19 by country, state and age",
            covid_c3r3: "ID, Picture, First Name, Middle Name, Surname, Mother's surname (latin america only), Age, Country, Gender, State, Other diseases, Symptoms, Date when symptoms started, Is treated with medical attention?",
            covid_c2r4: "Last travel's report by date of departure and date of arrival",
            covid_c3r4: "ID, Picture, First Name, Middle Name, Surname, Mother's surname (latin america only), Age, Country of residence, Country where they traveled, Date of departure, Date of arrival, Cities visited",
            covid_c2r5: "It's a report that indicates, by country and state, the number and rate of infected, dead and recovered people",
            covid_c3r5: "Country, State, Country's population, Number of infected people, Percentage of infected people / country's population, Dead people, Percentage of dead people / country's population, Recovered people, Percentage of recovered people / country's population",
            covid_c2r6: "Report of social distancing models. The possible social distancing models considered for this project were: Free movement, Quarantine, 1 every 4 people go out constantly, 1 every 8 people go out constantly, take constantly as not exclusively for first need activities like going to buy groceries or going to work in the case of essential workers",
            covid_c3r6: "Country, Model's start date, Model's end date, Name of the applied model",
            covid_c2r7: "Infection's curve graph",
            covid_c3r7: "Country, Start's Date, Final Date, Graph",
            covid_c2r8: "Flights and passengers by country and date",
            covid_c3r8: "Airline, Flight's Nº, From (Country), To (Country), From (State), To (State), Departure's date, Arrival's date, Passenger's Nº, Picture, First Name, Middle Name, Surname, Mother's surname (latin america only)",
            covid_c2r9: "Clinics and hospitals available",
            covid_c3r9: "Address, Clinic's name, Available beds, Available resources, Number of COVID-19 cases attended, Number of people dead by COVID-19, Number of recovered people",
            covid_c2r10: "Humanitarian help from other countries",
            covid_c3r10: "Country that offers the help, Country that receives the help, Date, Resources donated, Money donated",
            covid_c2r11: "Social distancing model's effectivity. The efectivity is calculated using the following formula: <code>(r/i)-(d/i)</code> where R = Recovered, I = Infected, D = Dead",
            covid_c3r11: "Country, Model, Date, Effectivity",
            covid_c2r12: "General statistics",
            covid_c3r12: "Number of infected people, Number of dead people, Number of recovered people, Percentage of infected people, Percentage of dead people, Percentage of recovered people. The percentage is calculated versus the country's population",
            covid_c2r13: "Report about the internet's usage by country and date",
            covid_c3r13: "Country, Internet provider, Date, Average upload's speed, Average download's speed, Averge hours of interruption per day",
            covid_c2r14: "Closed borders by country and date",
            covid_c3r14: "Country, Start's Date, End's Date",
            covid_docs1: "Entity relationship model",
            covid_docs2: "Simulation's Algorithm",
            covid_docs3: "Justification of the abstract data types used",
            covid_docs4: "Screenshots of all the reports, roles and privileges table",
            ...
            bdii_tit: 'PL/SQL and SQL Practices',
            bdii_desc: "Exercises in SQL and PL/SQL that include things such as advanced queries, stored procedures, cursors, triggers and abstract data types, designed to work in Oracle's Database manager",
            bdii_date: 'August 6th, 2020',
        ...
        es:{
            ...
            job_one_info: "Construí websites para la compañía venezolana Per Capital, puedes acceder a la página principal haciendo clic",
            job_one_link: 'aquí',
            ...
            education_one: 'Me gradué de Ingenieria Informática en la Universidad Católica Andrés Bello',
            ...
            /* NetDoc */
            netdoc_desc: 'Demo de red social para doctores y pacientes de enfermedades raras',
            netdoc_l1: 'Mostrar interacción entre doctores',
            netdoc_l2: 'Mostrat interacción entre pacientes',
            netdoc_l3: 'Mostrar interacción entre doctores y pacientes',
            netdoc_date: '10 de Agosto de 2020',
            netdoc_v: 'Vistas',
            netdoc_c1: 'Vista',
            netdoc_c2: 'Nombre',
            netdoc_c1r1: 'Posts',
            netdoc_c2r1: 'Escribe un post en una comunidad de la que formes parte',
            netdoc_c1r2: 'Comunidades',
            netdoc_c2r2: 'Explore, postea e invita gente a una comunidad',
            netdoc_c1r3: 'Descubrir comunidades',
            netdoc_c2r3: 'Explora y únete a diferentes comunidades',
            netdoc_c1r4: 'Chat',
            netdoc_c2r4: 'Envía mensajes directos a otros usuarios y chats grupales',
            netdoc_c1r5: 'Login/Registro',
            netdoc_c1r6: 'Recuperación de contraseña',
            netdoc_c1r7: 'Perfil/Editar perfil',
            netdoc_c1r8: 'Investigaciones',
            netdoc_c2r8: 'Descubre y forma parte de investigaciones de colegas médicos',
            netdoc_c1r9: 'Pacientes',
            netdoc_c2r9: 'Gestiona pacientes y su historia médica',
            netdoc_c1r10: 'Buscador de enfermedades',
            netdoc_c2r10: 'Descubre todo lo relacionado con enfermedades raras, filtra por nombre o por síntoma(s)',
            netdoc_docs1: 'Documento de visión',
            netdoc_docs2: 'Diagrama de casos de uso',
            netdoc_docs3: "Requerimientos del sistema completo",
            netdoc_dd: "Documento de diseño",

            /* COVID */
            covid_tit: 'Sistema de reportería Covid 19',
            covid_desc: 'Diseño de base de datos que soporta reportes sobre las personas infectada con COVID-19',
            covid_l1: 'Construir reportes utilizando la herramienta Jaspersoft Studio con la información más relevante acerca de las infecciones de COVID-19 en todo el mundo',
            covid_l2: "Construir un datamart que utilice procesos ETL (Extracción, Transformación y Carga) para obtener información de una base de datos remota",
            covid_l3: "Crear y configurar roles y privilegios de usuario en la base de datos",
            covid_l4: "Crear y ejecutar procedimientos que simulen, en tiempo real, el proceso de infecciones, uso de internet, cierre de fronteras, etc",
            covid_date: '4 de Agosto de 2020',
            covid_r: 'Reportes',
            covid_c1: 'Reporte',
            covid_c2: 'Descripción',
            covid_c3: 'Muestra',
            covid_c2r2: 'Personas infectadas por país, esto permitirá mantener una cuenta para detectar población infectada y mejorar los planes de acción para su recuperación',
            covid_c3r2: "Foto, Primer Nombre, Segundo Nombre, Apellido, Segundo Apellido, Fecha de nacimiento, País de residencia, Estado, Patologías",
            covid_c2r3: "Síntomas de las personas con COVID-19 por país, estado y edad",
            covid_c3r3: "ID, Foto, Primer Nombre, Segundo Nombre, Apellido, Segundo Apellido, Edad, País de residencia, Género, Estado, Patologías, Síntomas, Fecha de inicio de los síntomas, ¿Es tratado con atención médica?",
            covid_c2r4: "Reporte de último viaje por fecha de inicio y fecha de llegada",
            covid_c3r4: "ID, Foto, Primer Nombre, Segundo Nombre, Primer Apellido, Segundo Apellido, Edad, País de residencia, País de destino, Fecha de inicio, Fecha de llegada, Ciudades visitadas",
            covid_c2r5: "Reporte que indica por país y estados el número y porcentaje de infectados, muertos y recuperados por COVID-19",
            covid_c3r5: "País, Estado, Población, Número de infectados, Porcentaje de infectados/Población, Porcentaje de muertes/Población, Porcentaje de recuperados/Población",
            covid_c2r6: "Reporte de modelos de distanciamiento social. Los modelos de distanciamiento social considerados para este proyecto son: Libre movimiento, Cuarentena, 1 de cada 4 salen, 1 de cada 8 salen. Se entiende por 'salir' como salir para actividades fuera de actividades esenciales como comprar comida or ir a trabajar en el caso de trabajadores esenciales",
            covid_c3r6: "Modelo, Fecha de inicio, Fecha fin, Nombre del modelo",
            covid_c2r7: "Curva de infección",
            covid_c3r7: "País, Fecha de inicio, Fecha de fin, Gráfico",
            covid_c2r8: "Vuelos y pasajaeros por país y fecha",
            covid_c3r8: "Aerolinea, Número de vuelo, País de origen, País de destino, Estado de orígen, Estado destino, Fecha de inicio, Fecha de llegada, Número de pasajero, Foto, Primer Nombre, Segundo Nombre, Primer Apellido, Segundo Apellido",
            covid_c2r9: "Clínicas y hospitales disponibles",
            covid_c3r9: "Dirección, Nombre de la clínica, Camas disponibles, Insumos disponibles, Número de casos de COVID-19 atendidos, Números de muertos por COVID-19, Número de recuperados de COVID-19",
            covid_c2r10: "Ayuda humanitaria de otros países",
            covid_c3r10: "País que ofrece la ayuda, País que recibe la ayuda, Fecha, Insumos donados, Dinero donado",
            covid_c2r11: "Efectividad de modelo de distanciamiento social. La efectividad es calculada usando la siguiente fórmula: <code>(r/i)-(d/i)</code> donde R = Recuperados, I = Infectados, D = Muertos",
            covid_c3r11: "País, Modelo, Fecha, Efectividad",
            covid_c2r12: "Estadísticas generales",
            covid_c3r12: "Número de infectados, Número de muertos, Número de recuperados, Porcentaje de infectados, Porcentaje de muertos, Porcentaje de recuperados. El porcentaje es calculado sobre la población del país",
            covid_c2r13: "Reporte sobre el uso de internet por país y fecha",
            covid_c3r13: "Pais, Proveedor de internet, Fecha, Velocidad de subida promedio, Velocidad de bajada promedio, Horas diarias de interrupción de servicio",
            covid_c2r14: "Fronteras cerradas por país y fecha",
            covid_c3r14: "País, fecha de inicio, fecha fin",
            covid_docs1: "Modelo entidad relación",
            covid_docs2: "Algoritmo de simulación",
            covid_docs3: "Justificación de los tipos de dato abstractos utilizados",
            covid_docs4: "Screenshots de todos los reportes, tabla de roles y privilegios",
            ...
            bdii_tit: 'Prácticas de SQL y PL/SQL',
            bdii_desc: "Ejercicios escritos en SQL y PL/SQL que incluye queries avanzados, stored procedures, cursores, triggers y tipos de datos abstractos, está diseñado para el manejador Oracle",
            bdii_date: '6 de Agosto de 2020',
